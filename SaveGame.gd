...
@export var bonus_velocidade_rajada: float = 0.0 
@export var bonus_rajada_flechas: int = 0
@export var bonus_cadencia_arco: float = 0.0
@export var bonus_velocidade_flecha: float = 0.0
...
@export var bonus_velocidade_missil: float = 0.0
@export var bonus_leque_misseis: int = 0
@export var bonus_foco_leque: float = 0.0
